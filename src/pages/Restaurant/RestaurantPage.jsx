...
function RestaurantPage() {
  ...
  const handleSearch = async (data) => {
    ...
    if (data.searchText && data.searchText.trim() !== '') {
      ...
      setRestaurantsPopular(filtered);
    } else {
      setRestaurantsPopular(results.places);
    }
  };
      ...
      <Content className={content}>
        ...
        <div className={banner}>
          ...
          <div className={heroContent}>
            <h1 className={title}>
              Khám phá thế giới qua hương vị ẩm thực địa phương
            </h1>
        ...
        {!isSearch && (
          ...
          >
            <div className={popularDestinations}>
              ...
              <ServiceList places={restaurantsPopular} />
            </div>
          </motion.div>
        )}
        {isSearch && (
