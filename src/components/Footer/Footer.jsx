      ...
      <Row gutter={[32, 32]}>
        <Col xs={24} sm={12} md={8} lg={6}>
          ...
          <Text style={{ color: '#d9e6ff', fontSize: 14, lineHeight: 1.6 }}>
            Nền tảng kết nối du lịch hiện đại — nơi bạn khám phá, đặt dịch vụ và
            trải nghiệm những chuyến đi tuyệt vời.
          </Text>
        </Col>
        ...
        <Col xs={24} sm={12} md={8} lg={6}>
          ...
          <Space direction='vertical' size='small'>
            <Text style={{ color: '#fff' }}>
              <EnvironmentOutlined /> 715/25, Đường 3/2, Phường An Bình, Cần Thơ
            </Text>
            <Text style={{ color: '#fff' }}>
